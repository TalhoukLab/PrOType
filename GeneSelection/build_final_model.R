...
write.csv(Final_Predictions, file.path("GeneSelection/outputs", "Final_Predictions.csv"))
write.csv(final_glist, file.path("GeneSelection/outputs", "final_glist.csv"))
write_rds(final_model, file.path("GeneSelection/outputs", "final_model.rds"))
...
write_csv(arl_predictions, file.path("GeneSelection/outputs", "arl_predictions.csv"))
...
write_csv(bro_het_test_predictions, file.path("GeneSelection/outputs", "bro_het_test_predictions.csv"))
...
write_csv(cell_lines_predictions, file.path("GeneSelection/outputs", "cell_lines_predictions.csv"))
...
write_csv(lax_van_om_test_predictions, file.path("GeneSelection/outputs", "lax_van_om_test_predictions.csv"))
