...
```{r clinical-details}
clin <- data.frame(
  c("Patient ID:", "Kit ID:", "Sample ID:", "Date Extracted:", "Input:", "Quality Control:"),
  c("_", strsplit(qc_data[["sample"]], split = "_")[[1]][3], qc_data[["sample"]],
    qc_data[["nanostring.date"]], "500ng Total RNA (measure by Nanodrop, A260/A280: _)",
