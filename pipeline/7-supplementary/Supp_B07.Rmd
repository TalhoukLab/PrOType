...
nec_dat <- readxl::read_excel(here("data/FinalSubtype_AnalyticFile.xlsx"))
cd8_dat <- readxl::read_excel(here("data/OTTA DB_CD8_20180821 for Mike_HGS CCC END_edit_all.xlsx"))

fig_path <- "pipeline/7-supplementary/figures/B07"
```
...
print(p)
ggsave(here(fig_path, "entropy_scatterplot_agree.pdf"), p, width = 7, height = 5)
```
...
print(p)
ggsave(here(fig_path, "entropy_scatterplot_pred_aa.pdf"), p, width = 7, height = 5)
```
...
print(p)
ggsave(here(fig_path, "entropy_scatterplot_pred_tcga.pdf"), p, width = 7, height = 5)
```
...
print(p)
ggsave(here(fig_path, "entropy_boxplot_agree.pdf"), p, width = 7, height = 5)
```
...
print(p)
ggsave(here(fig_path, "entropy_boxplot_pred_aa.pdf"), p, width = 7, height = 5)
```
...
print(p)
ggsave(here(fig_path, "entropy_boxplot_pred_tcga.pdf"), p, width = 7, height = 5)
```
...
ggsave(here(fig_path, "km_all_array.pdf"), plots_km_aa, width = 7, height = 10)
```
...
ggsave(here(fig_path, "km_tcga.pdf"), plots_km_tcga, width = 7, height = 10)
```
...
ggsave(here(fig_path, "km_conc.pdf"), plots_km_conc, width = 7, height = 10)
```
...
ggsave(here(fig_path, "km_disc_all_array.pdf"), plots_km_disc_aa, width = 7, height = 10)
```
...
ggsave(here(fig_path, "km_disc_tcga.pdf"), plots_km_disc_tcga, width = 7, height = 10)
```
