...
```{r aa_kmodes}
# All-array samples
aa_dat <- readRDS(here("data/npcp-hcNorm_ov.afc1_xpn.rds"))
aa_samples <- gsub("_", "-", stringr::str_sub(rownames(aa_dat), 15, 26))

# All-array kmodes clustering labels
aa_clusts <- readRDS(here("data/all_clusts_ov.afc1_xpn.rds"))
aa_kmodes <- aa_clusts %>% 
  dplyr::transmute(
    sample = aa_samples,
