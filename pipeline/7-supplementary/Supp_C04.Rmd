...
## _Table SC1_ Comparison of final model predictions with consensus labels from the training set (group 1)
...
## _Table SC2_ Comparison of final model predictions with consensus labels from the confirmation set (group 2)
...
## _Table SC3_ Comparison of final model predictions with consensus labels from the first validation set (group 3)
...
## _Table SC4_ Comparison of final model predictions with consensus labels from the second validation set (group 4)
...
## _Table SC5_ Comparison of final model predictions with consensus labels from the overlap set 
