...
fits <- readRDS(file.path(input_dir, "rf_alternate_c1.rds"))
...
saveRDS(conf2, file.path(outputDir, "CrossPlatform/output/overlap_pred_nstring_2.rds"))
saveRDS(conf3, file.path(outputDir, "CrossPlatform/output/overlap_pred_nstring_3.rds"))
