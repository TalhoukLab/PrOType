...
echo 'cli::cat_line("Post-processing step 5")' >> $Rname4
echo 'source("R/5_post_processing/5-predict_C2.R")' >> $Rname4
echo 'cli::cat_line("Post-processing step 6")' >> $Rname4
echo 'source("R/5_post_processing/6-probe_mapping_C2.R")' >> $Rname4
echo 'cli::cat_line("Post-processing step 7")' >> $Rname4
echo 'source("R/5_post_processing/7-mapping_signatures_C2.R")' >> $Rname4

file_to_submit=($shname0 $shname1 $shname2 $shname4)
